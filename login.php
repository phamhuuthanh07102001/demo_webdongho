	...
	<div class="content">
		<div class="login_panel">
			...
			<form action="" method="POST">
				...
				<div class="buttons">
					<div><input type="submit" name="login" class"grey" value="Đăng nhập" style="
    background: #ffffff;
"></div>
				</div>
			</form>
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<div>
									<input type="password" name="password" placeholder="Nhập Password..." style=" width: 100%;height: 37px; margin-top: 5px;
">
								</div>
							</td>
						</tr>
				...
				<div class="search">
					<div><input type="submit" name="submit" class"grey" value="Đăng ký" style=" background: #ffffff;main-bottom:10px;">
					</div>
				</div>
