    ...
    <div class="main">
        <div class="content">
            ...
            <?php
                ...
                // $delCart = $ct->del_all_data_cart();
            ?>
                <p class="success_note">Bạn đã đặt hàng thành công ,Chúng tôi sẽ liên hệ bạn sớm<a href="orderdetails.php"></a></p>
                <h2 class="success_order">Thanh toán VNPAY thành công</h2>
            <?php
            } else {
            ?>
