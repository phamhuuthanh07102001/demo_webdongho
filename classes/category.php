	...
	*/
	class category
	{
		...
		public function insert_category($catName){
			...
			if(empty($catName)){
				$alert = "<span class='error'>Category không được để trống</span>";
				return $alert;
			}else{
				$query = "INSERT INTO tbl_category(catName) VALUES('$catName') "; //$catname đc truyền vào từ form
		...
		public function del_category($id)
		{
			...
			if($result){
				...
				$alert = "<span class='success'>Xoá không thành không</span>";
				return $alert;
			}
		}
