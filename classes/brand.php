...
<?php 
	...
	*/
	class brand
	{
		...
		public function getbrandbyId($id) // lấy ra id để sửa
		{
		...
		public function update_brand($brandName,$id)
		{
			...
			if(empty($brandName)){
				...
				if($result){
					...
					$alert = "<span class='error'>Cập nhật thương không hiệu thành công</span>";
					return $alert;
				}
			}
		...
		public function del_brand($id)
		{
			...
			if($result){
				...
				$alert = "<span class='success'>Xoá thương hiệu không thành công</span>";
				return $alert;
			}
		}
